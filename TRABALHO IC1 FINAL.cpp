	...
	while(1)
	{
		...
		if(m==1) //abre programa 1
		{
    		...
    		{	
				...
				{
                        printf("\nVocê escolheu digitar os números\n");
				...
				{
                        printf("\nVocê escolheu fazer o cálculo da Média Simples");
            		somaNum = 0;
				...
				{
                        printf("\nVocê escolheu fazer o cálculo da Média Ponderada.\n");
        		...
        		{
                        printf("\nVocê escolheu fazer o cálculo do Desvio Padrão.\n");
            		somaNum = 0;
				...
				{
                        printf("\nVocê escolheu determinar o Maior Valor\n");
				...
				{
                        printf("\nVocê escolheu determinar o Menor Valor\n");
